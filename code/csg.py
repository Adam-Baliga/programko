...
class Primitive: 
    ...
    """np.array of shape (3,) representing the translation of the object in 3D space from the origin"""

    rotation: np.array
    """np.array of shape (3,3) representing the inverse rotation matrix of the object(representing the cumulative rotation of the object)"""
    
    bounding_sphere_radius: float 
    """float representing the radius of the bounding sphere of the object - used for quick rejection of rays that are too far from the object"""
    ...
    def reverse_transform(self,p:np.array):
        """Applies the inverse transformation to point p to bring it back to the object's local coordinate system"""
    ...
    def sdf(self,p:np.array):
        """
        Calculates the signed distance from point p to the surface of the primitive.
...
class Box(Primitive):
    ...
    """Represents the dimensions of the box as a numpy array [length, width, height]"""
...
class Sphere(Primitive):
    ...
    radius: float
    """float representing the radius of the sphere"""
...
class Cylinder(Primitive):
    ...
    radius: float
    """float representing the radius of the cylinder"""

    height: float
    """float representing the height of the cylinder"""
...
class CSG_object_node:
    ...
    primitive: Primitive
    """instance of a Primitive subclass (Box, Sphere, Cylinder) if the node is a leaf, otherwise None"""

    operator: str
    """string representing the operation ("union", "intersection", "difference") if the node is not a leaf, otherwise None 
    applies the operation to the left and right child nodes
    """


    center:np.array
    """np.array of shape (3,) representing the center of rotation of the object and all its children - used for rotation transformations
    - for leaf nodes (primitives),whe
    n created the center is at the origin [0,0,0]
